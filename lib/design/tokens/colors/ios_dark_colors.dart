...
/// iOS — Dark appearance.
///
/// Parallel interpretation layer: dark appearance values only.
/// No runtime logic, no derived colors.
class IosDarkColors extends AppColors {
  const IosDarkColors();

  @override
  Color get brandPrimary =>
      // Hue preserved; brightness slightly increased for dark surfaces.
  ...
  @override
  Color get brandSurface => const Color(0xFF1C1C1E);
  ...
  @override
  Color get surfaceElevated => const Color(0xFF2C2C2E);

  @override
  Color get neutralDivider => const Color(0xFF38383A);

  @override
  Color get surfaceBorder =>
      // Subtle card outline; lower contrast than dividers.
      const Color(0x2638383A);
  ...
  @override
  Color get stateDisabled => const Color(0xFF475569);
